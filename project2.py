# Project2 code for the second project of COMP472 - AI class at Concordia University.
# Written by: Soufiane Bouabdallah - ID: 40029995
# Description: Required Naive Bayes language identification model.
...
# get the hyperparameters and the training & testing files from the arguments
...
# trace file
trace_file = open("trace_"+vocabulary_type+"_"+ngram_size+"_"+str(smoothing_value)+".txt", "w+", encoding="utf-8")
...
# evaluation file
evaluation_file = open("eval_"+vocabulary_type+"_"+ngram_size+"_"+str(smoothing_value)+".txt", "w+", encoding="utf-8")
